  ...
  return (
    <section className={classes.Container}>
      ...
      <p className={classes.Paragraph}>
        Welcome to the About page of our Final Year Research Project website! As
        a group, we are passionate about exploring innovative solutions to
      ...
      <div className={classes.Us}>
        ...
        <div className={classes.Who}>
          ...
          <p>
            Our project aims to develop a predictive model that can estimate the
            impact of precipitation, rainfall, and temperature on forest cover
            changes. Data Collection and Preprocessing: Comprehensive datasets
            ...
            generalizability. Analysis and Interpretation: Results obtained from
            the model are analyzed to uncover valuable insights into the
            ...
            valuable guidance to policymakers, environmental organizations, and
            forest managers, enabling informed decisions and proactive measures
        ...
        <div className={classes.Who}>
          ...
          <p>
            The project aims to bridge the gap between scientific knowledge and
            real-world applications. The outcomes of our study will provide
            valuable guidance to policymakers, environmental organizations, and
            forest managers, enabling informed decisions and proactive measures
            for forest conservation.
          </p>
        ...
        <div className={classes.Who}>
          ...
          <p>
            ...
            outcomes. We are excited to share our findings and contribute to the
            collective efforts aimed at preserving our planet&apos;s precious
            forest resources. Thank you for visiting our website, and we
            appreciate your interest in our final year research project!
          </p>
        </div>
      </div>
